...
<template>
  <div class="relative" @mouseover="hoveringNode = true" @mouseleave="hoveringNode = false">
    <IconPlusCircle
      ...
      class="absolute -bottom-3 left-1/2 -ml-3 h-6 w-6 cursor-pointer fill-white text-neutral-400 hover:fill-neutral-200 dark:fill-neutral-900 dark:hover:fill-neutral-700"
      @click="$emit('createNode', 'create', null, 'main', null, props.nodeOrder)"
    />
    <IconPlusCircle
      v-if="hoveringNode && nodeType != 'root'"
      class="absolute -right-3 top-1/2 -mt-3 h-6 w-6 cursor-pointer fill-white text-neutral-400 hover:fill-neutral-200 dark:fill-neutral-900 dark:hover:fill-neutral-700"
